...
('vou dar uma grande festa para comemorar meu aniversório','alegria'),
...
('por motivo torpe, com emprego de meio cruel e com impossibilidade de defesa para a vêtima','desgosto'),
('a inveja e tão vil e vergonhosa que ninguem se atreve a confessó-la','desgosto'),
...
('não há animal mais degradante, estápido, covarde, lamentável, egoísta, rancoroso e invejoso do que o homem','desgosto'),
...
('mas essa missóo e arriscada','medo'),
...
('se ficarmos quietos eles não vêo nos achar','medo'),
...
('me descobriram, iráo me prender!','medo'),
...
('seu poláticos usam suas forças para afugentar e amedrontar o povo','medo'),
...
('sóo apenas injurias sobre mim','raiva'),
...
('não aguento todo esse assedio','raiva'),
...
('pare de frescura e vê trabalhar','raiva'),
...
('incŕivel, cabe em qualquer lugar!','surpresa'),
('você por aqui?','surpresa'),
('não da pra acreditar no que ela me contou','surpresa'),
...
('e serio mesmo? não da pra acreditar','surpresa'),
...
('suas roupas sóo realmente lindas','surpresa'),
...
('seus olhos sóo surpreendentemente verdes','surpresa'),
('os poláticos se surpreendem quando alguem acredita neles','surpresa'),
...
('minhas palavras vêo emudecer se não parar de me surpreender','surpresa'),
('a mulher e um efeito deslumbrante da natureza','surpresa'),
('estou deslumbrada com essas jáias','surpresa'),
...
('essas pessoas sóo esplándida','surpresa'),
...
('quando eu penso em você realmente dai','tristeza'),
...
('ela esta com depreção','tristeza'),
('a depreção aflige as pessoas','tristeza'),
...
('ninguem lembrou do meu aniversório','tristeza'),
...
('a preocupação deveria nos levar a ação não a depreção','tristeza'),
...
('congratulações pelo seu aniversório','alegria'),
...
('vamos ter muita diversóo','alegria'),
...
('os apaixonados sóo maravilhosos','alegria'),
...
('os golpes da adversidade sóo terrivelmente amargos','desgosto'),
...
('o destino e cruel e os homens não sóo dignos de compaixão','desgosto'),
...
"""
('ate que enfim, não ageuntava mais te esperar','raiva'),
...
('eu amaliçôo você e a sua família','raiva'),
('não me amole','raiva'),
...
('esses livros sóo magníficos','surpresa'),
...
('como e formidavel a presença de todos','surpresa'),
...
('tenho muito da do cachorro','tristeza'),
...
('nossa condoláncias e tristeza a sua perda','tristeza'),
('desanimo, raiva, solidao ou vazies, depreção','tristeza'),
...
('quem esta descontente com os outros esta descontente consigo própio','tristeza'),
('a torcida esta descontente com a demissóo do tecnico','tristeza'),
('estou bastante aborrecido com o jornal','tristeza'),
('me sinto solitário e entediado','tristeza'),
('a vida e solitária para aqueles que não sóo falsos','tristeza'),
('como com compulsóo depois da depreção','tristeza'),
...
('a depreção vai me derrubar','tristeza'),
('suas desculpas sóo falsas','tristeza'),
